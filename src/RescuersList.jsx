            ...
            <div className="container">
                ...
                <div className="rescuerbody">
                    ...
                    <div className="rescuerbodyright">
                        <Button style={{ backgroundColor: "#cedfb9", marginLeft: '7%', borderColor: "#192928", marginTop: "10%", fontFamily: "Baloo Da", fontSize: "large" }} className="AFDR" onClick={() => { navigate('/rescuerapply') }}>Apply To Be A Rescuer</Button>
                    </div>
                </div>
            </div>
        </div >
