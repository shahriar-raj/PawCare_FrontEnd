    ...
    return (
        <div>
            ...
            <div className="profile_header">
                ...
                <Button className='Profile active' icon={<FontAwesomeIcon icon={faUser} />} style={{ backgroundColor: "#192928", color: "white", fontFamily: "Baloo Da", marginLeft: "10%" }} onClick={() => { navigate('/profile') }}>
                    My Profile
                </Button>
