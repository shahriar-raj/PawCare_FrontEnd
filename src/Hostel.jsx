...
import { faIgloo,faMapMarkedAlt,faCat,faCalendarAlt ,faUsers,faUser, faFilter, faHome, faHandHoldingDollar, faPaw,faDog, faImage, faPlayCircle, faHeart, faRetweet, faComment } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="hostel-container">
            <div className="profile_header">
                ...
                <Button className='BookHostel active' icon={<FontAwesomeIcon icon={faIgloo} />} style={{ backgroundColor: "#192928", color: "white", fontFamily: "Baloo Da", marginLeft: "0%" }} onClick={() => { navigate('/hostel') }}>
                    Book a Hostel
                </Button>
